...
Жюри Техлаба и МИК: формула выше → [`submission/README.md`](submission/README.md) → CLI выше. Трек сидящего члена жюри — этот CLI. Браузерная оболочка ревью — ноутбук ИТ-ментора, не СОД. Это пакет доработки, не акт Checkpoint.
...
tests_passed: backend=3020, frontend=323; commit eff1f830a834; see docs/evidence/runtime-baseline-latest.json · src ~96335 LOC; tests ~63337 LOC; extraction macro_f1=0.8600000000000001 (fixture corpus; not product accuracy)
