...
> **КТ#2 (20.08.2026), Техлаб Москва, задача 07, заказчик — ГК «Самолёт».** Пакет подачи: [`submission/README.md`](submission/README.md).
>
...
tests_passed: backend=2469, frontend=56; commit 199690e5d11d; see docs/evidence/runtime-baseline-latest.json · src ~77833 LOC; tests ~51404 LOC; extraction macro_f1=0.8600000000000001 (fixture corpus; not product accuracy)
