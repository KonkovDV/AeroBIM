...
**AeroBIM ловит расхождения между файлами комплекта: площадь в ведомости против площади в IFC, отметка в ПД против отметки в РД, требование ТЗ против фактического наполнения. Каждый файл по отдельности открывается чисто. Дефект живёт в шве и всплывает на площадке.**
...
| **Ждёт измерения** | Независимый размеченный комплект (двое разметчиков) для RT-001a · подписанный профиль Самолёта RT-002b · федеративный MEP RT-003 · импорт BCF в их СОД |
