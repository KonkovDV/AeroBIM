...
**Claim:** public machine-readable AGR CIM checks (IDS). City methodology files, **not** the territorial NPA itself (that is 17-ПП + ДГП-Р-1/26). Not a customer customer-approved acceptance profile. Does not close Checkpoint GO / RT-002. Does not substitute GrK art. 49 expertise.
