...
**Operational freeze SHA (historical, 2026-07-21):** `f2615e7` (eng F–L: precision gates, SLA claim gate, BCF ladder, revision compare, threat model, open-core ADR). Do **not** treat this SHA as HEAD or as the publishable metrics pin. Refresh when claiming metrics — current publishable counts are [`docs/evidence/runtime-baseline-latest.json`](../../docs/evidence/runtime-baseline-latest.json) (`attested_by=ci`, commit `626078771242891a8a6f0c83d319ca958f7be593`, 2026-08-28T07:58:38Z): backend **2641** passed / **2660** collected / 19 skipped / 0 failed; frontend **57**.  
