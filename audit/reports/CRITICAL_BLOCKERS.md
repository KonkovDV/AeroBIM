...
**Operational freeze SHA (historical, 2026-07-21):** `f2615e7` (eng F–L: precision gates, SLA claim gate, BCF ladder, revision compare, threat model, open-core ADR). Do **not** treat this SHA as HEAD or as the publishable metrics pin. Refresh when claiming metrics — current publishable counts are [`docs/evidence/runtime-baseline-latest.json`](../../docs/evidence/runtime-baseline-latest.json) (`attested_by=ci`, commit `1b01535e6955109e3512bdd051422c029954cef8`, 2026-08-28T10:35:19Z): backend **2644** passed / **2663** collected / 19 skipped / 0 failed; frontend **57**.  
