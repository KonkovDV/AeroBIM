...
**Operational freeze SHA (historical, 2026-07-21):** `f2615e7` (eng F–L: precision gates, SLA claim gate, BCF ladder, revision compare, threat model, open-core ADR). Do **not** treat this SHA as HEAD or as the publishable metrics pin. Refresh when claiming metrics — current publishable counts are [`docs/evidence/runtime-baseline-latest.json`](../../docs/evidence/runtime-baseline-latest.json) (`attested_by=ci`, commit `019962141606dd6dabb373f66c0425920bb3c923`, 2026-08-28T17:42:48Z): backend **2694** passed / **2713** collected / 19 skipped / 0 failed; frontend **57**.  
