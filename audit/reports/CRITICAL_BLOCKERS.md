...
**Operational freeze SHA (historical, 2026-07-21):** `f2615e7` (eng F–L: precision gates, SLA claim gate, BCF ladder, revision compare, threat model, open-core ADR). Do **not** treat this SHA as HEAD or as the publishable metrics pin. Refresh when claiming metrics — current publishable counts are [`docs/evidence/runtime-baseline-latest.json`](../../docs/evidence/runtime-baseline-latest.json) (`attested_by=ci`, commit `fc1f03838cb61660adeab9b3a872315c7469eaa5`, 2026-08-28T20:42:21Z): backend **2701** passed / **2720** collected / 19 skipped / 0 failed; frontend **57**. Prior same-day pin `019962141606` / **2694** passed (17:42Z) is **historical**.  
...
- **Product HOLD — RT-003 still OPEN** until customer-side IFC export of the federated (NWD) set + signed scope + verified geometry. Inventory, planted clash, and public duplex clash ≠ delivered.  
