...
| IfcLLM arXiv:2605.13236 | Relational+graph backends; 93–100% on **30 scenarios / 3 models** | Quoting as product IFC-LLM accuracy — **forbidden**; I9 = **advisory scaffold** only |
...
2. I9 is **advisory scaffold only** — relational fixture QA + stub fallback; **GraphRAG / IfcLLM runtime absent** — do not demo IfcLLM numbers as AeroBIM.  
3. Untracked `docs/samolet-techlab-scorecard-2026.zip` must not be committed (local only).
...
I9 port wiring landed as **advisory scaffold** — still not a product KG capability and does not unlock GO.
