...
| Hybrid AI routing foundation | `domain/hybrid/*` + 61 tests | fixture | Yes | MED if misread as delivered | Domain-pure fail-closed foundation; verdict-neutral (OFF==ON); NOT in verdict/live egress; masking ≠ anonymity |
