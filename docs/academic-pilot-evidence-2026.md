...
|---|---|---|
| Automated code checking (ACC) | Alnuzha et al., ITcon 2025 SLR — hybrid rule + statistical models | Rule-first narrative extraction; trained pipelines deferred until P/R gated |
| IFC reliability | IFC-QA benchmark — grounding failures dominate model-only paths | Deterministic IFC/IDS kernel; non-auditable models outside sign-off |
...
- **Excluded from pilot sign-off:** non-deterministic drawing analysis, trained extraction pipelines, full CDE, autonomous orchestration platforms
