...
| **ПП РФ 614** от 17.05.2024 (заменило ПП 1431; действует до 01.09.2030), п. 7 | **PDF/A**; LandXML для модели местности; **IFC** или иной формат с **открытой спецификацией** для цифровой информационной модели |
