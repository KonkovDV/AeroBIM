...
**Six desks (17.08).** TechLab / MIK / tracker / IT mentor / science / VC: [Jury × MIK red team](quality/RED_TEAM_JURY_MIK_NOVATOR_KT2_2026_08_15.md) § Current pass. Form 5/5 ≠ Checkpoint GO.
...
| [Hostile QA playbook](demo/) | Scripts pinned to SSOT |
...
| [Samolet intake ask](partners/_08_15.md) | Pack / profile / adjudicators / CDE |
| [Wedge freeze](partners/_2026_08_16.md) | Product = IFC Acceptance Gate |
...
Intake-form completeness = **5/5 fields** have a deliverable in this tree. That is not Checkpoint GO, not MIK stage 3, not a measured effect. Checkpoint **NO_GO**. Fixes are code+tests in this tree; rehearsal / operator mp4 / ЛК upload are human (`RED_TEAM_FINAL_VERDICT_2026_08_16.md` §4).
...
| 2 | Подход к решению | [Jury memo](docs.md) + [readiness](partners/TECHLAB_TASK_07_READINESS_2026.md) + [wedge freeze](partners/_2026_08_16.md) | deterministic gate; advisory ≠ verdict |
| 3 | Сравнение решений | [Task-07 comparison](demo/KT2_TASK07_COMPARISON_2026_08.md) | competitor numbers = их claims |
| 4 | Харденинг | [Hostile QA playbook](demo/) §2 | §0 formula; RED_TEAM_FINAL_VERDICT §1 |
