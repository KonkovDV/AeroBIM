...
tags: [aerobim, documentation, tier-0, ssot, samolet]
claim_boundary: "Public Tier-0 for Samolet TZ. Checkpoint NO_GO until RT-001/002/003."
---

# Tier-0 Documentation Index (Samolet public SSOT)
...
| [`pilot-claim-boundary-2026.md`](pilot-claim-boundary-2026.md) | Verified vs planned (**I9 = advisory scaffold**) |
...
| File | Replaced by |
|------|-------------|
| [`06-architecture-reference.md`](06-architecture-reference.md) | `TARGET_HYBRID_ARCHITECTURE_TZ_2026.md` |

## Not on public GitHub

Engineering wave logs, Red Team deltas, and AI prompts live under **local** `.local/engineering-docs/` (gitignored). See [`LOCAL_OPERATOR_ARTIFACTS.md`](LOCAL_OPERATOR_ARTIFACTS.md).
