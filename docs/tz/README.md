...
Подготовка к **заказчик канала × ТехЛаб 2026, Задача 07** (ассистент эксперта / openBIM QA).

| Doc | Role |
|-----|------|
| **[`TZ_TECHLAB_TASK_07_V2_2026.md`](TZ_TECHLAB_TASK_07_V2_2026.md)** | **ТЗ v2.0 (полный документ)** — TBD закрыты, Claims Lock, research 2025–2026 |
...
| [`TRI_SOURCE_REQUIREMENTS_MATRIX_2026.md`](TRI_SOURCE_REQUIREMENTS_MATRIX_2026.md) | **заказчик канала × Техлаб × МИК × отрасль × трекер** — трассируемость |
| [`../quality/INTERPRETATION_USE_LEDGER_2026_08.md`](../quality/INTERPRETATION_USE_LEDGER_2026_08.md) | Kane IUA: licensed vs blocked inferences |
