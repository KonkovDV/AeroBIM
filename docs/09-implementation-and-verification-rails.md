...
This document captures the operational discipline `Samolet` borrows from  without copying the whole platform process model.
...
It does not copy the full  4-phase protocol, multi-agent operating model, or MCP-specific governance into `Samolet`.
