...
| **Ishigaki-IDS-Bench** (arXiv:2605.22079) | PUBLIC_REAL | 166 gold IDS; **no IFC** | CC BY 4.0 | document processability 166/166 XML; not generation F1 | `.local/ishigaki-ids-bench` (gitignored JSONL) |
| **DrawingVQA** (arXiv:2607.15418) | PUBLIC / research | 92 expert Q | questions **BY-NC-SA**; drawings not public | **not downloaded** | link-only; VLM stays advisory |
