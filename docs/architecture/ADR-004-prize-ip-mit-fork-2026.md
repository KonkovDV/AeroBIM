...
исключительные права без доплаты к призу. PDF Положения в git нет; 14.09.2026
формулировка сверена с десктопным сканом (строка 6 в
[`ORDER_WEIGHTS_VERIFICATION_2026_09.md`](../quality/ORDER_WEIGHTS_VERIFICATION_2026_09.md)
— MATCH как риск, не как свершившийся факт). `attested_by` не ci.
...
- Вопрос организаторам — исходящее письмо владельца, не коммит.
