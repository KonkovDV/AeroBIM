...
**Implemented (2026-07-28 foundation + 2026-08-02 WP-02):** secure data-routing foundation in `domain/hybrid/*` (5-level classification, fail-closed policy, secret-safe audit, privacy guard) + `HybridRouteGate`. **WP-02** wires the gate as a mandatory **advisory pre-gate** on Analyze (`AdvisoryOrchestrator`): blocked → no advisory observations; never sets `summary.passed` (OFF==ON). Masking ≠ anonymity; PUBLIC VLM egress remains residual. Checkpoint NO_GO. See [`../../audit/reports/HYBRID_AI_FINAL_REPORT_2026_07_28.md`](../../audit/reports/HYBRID_AI_FINAL_REPORT_2026_07_28.md) · [`../ENGINEERING_STATUS_2026_08.md`](../ENGINEERING_STATUS_2026_08.md).
