...
Честные уступки: зрелость model checking и доля рынка — у зарубежных продуктов выше. У заказчика канала главный сосед — **Tangl + 10D**, не Solibri. Отличие AeroBIM — связка cross-doc + provenance + fail-closed + OFF==ON.
