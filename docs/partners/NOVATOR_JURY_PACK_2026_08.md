# Jury pack — Новатор / Техлаб (верхний слой)

**Дата:** 2026-08-04  
**Номинация (рекомендация):** «Меняющие реальность» · направление «Благоустройство и строительство»  
...
4. [`PITCH_NOVALTOR_TECHLAB_2026_08.md`](PITCH_NOVALTOR_TECHLAB_2026_08.md)  
