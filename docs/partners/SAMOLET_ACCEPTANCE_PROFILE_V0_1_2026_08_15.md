...
| Допустимые форматы | IFC (схема как в HEADER выгрузки Renga), PDF/2D той же ревизии, ТЗ/EIR текстом или таблицей |
...
Письмо: [`SAMOLET_KT2_ASK_2026_08_15.md`](SAMOLET_KT2_ASK_2026_08_15.md).
