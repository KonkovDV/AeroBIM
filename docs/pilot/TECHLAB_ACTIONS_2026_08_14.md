...
| 4 | Вопросы + демо ядра Бурнаеву; созвон с Михаилом | Человек проводит; ИИ готовит пакет | Пакет готов. 12.08 слот Бурнаева по календарю был; **минут в git нет**. **15.08:** вопросы 6–7 (Messick/Kane IUA; Solihin class 4). Второй слот Бурнаева: ждём AM. | [`../demo/CONSULTATIONS_2026_08_14.md`](../demo/CONSULTATIONS_2026_08_14.md) |
