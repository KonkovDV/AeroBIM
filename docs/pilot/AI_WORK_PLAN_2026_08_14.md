...
|---|---|---|---|
| 14.1 | Итоги встречи с трекером | [`../demo/TRACKER_MEETING_2026_08_14_FOLLOWUP.md`](../demo/TRACKER_MEETING_2026_08_14_FOLLOWUP.md) | **DONE** — заметок а в repo нет; протокол не выдуман |
