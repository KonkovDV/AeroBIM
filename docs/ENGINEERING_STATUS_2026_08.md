...
| **Qwen local (KT#2 W1)** | Studio adapter + PII allowlist+clip (bottom+left priors) + absolute-CRS fail-closed (RT-STAMP-12/13); Red Team `RED_TEAM_GRANT_STAMP_PII` v1.3 | PUBLIC/INTERNAL only; grant ≠ RT-001; Checkpoint NO_GO |
