...
| **Qwen local (KT#2 W1)** | Feasibility + plan; `private_qwen_local` / `private_yandex_ai_studio`; OpenAI-compat + token caps; compose CLI; OFF==ON; Alibaba Max NOT_VERIFIED | Studio cloud PUBLIC/INTERNAL only; not verdict |
