...
| **Qwen local (KT#2 W1)** | Studio adapter + **PII allowlist+clip** + **CRS fail-closed** (normalized-0-1 cropper; RT-STAMP-09/10/11); Red Team `RED_TEAM_GRANT_STAMP_PII` | PUBLIC/INTERNAL only; grant ≠ RT-001; Checkpoint NO_GO |
