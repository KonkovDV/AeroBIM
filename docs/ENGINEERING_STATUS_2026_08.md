...
| **Qwen local (KT#2 W1)** | Feasibility + plan; Studio adapter hardening; **PII allowlist+clip** (`content` only; stamp/title priors subtracted; unknown/pixel fail-closed); Red Team RT-STAMP-07/08 | Studio cloud PUBLIC/INTERNAL only; grant ≠ RT-001; Checkpoint NO_GO |
