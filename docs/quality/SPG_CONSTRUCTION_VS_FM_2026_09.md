...
| Файл | Объект | К ТЗ заказчика канала |
|---|---|---|
...
| RT-SPG-TIM-PACK | 49% ТИМ = комплект заказчика измерим | Пилот ТИМ ≠ ПД+РД+IFC под IDS; RT-001 OPEN |
...
Не говорить: «СПГ посчитал рынок ИИ — мы в нём»; «49% ТИМ = пакет заказчика готов»; «мы делаем digital twin / FM».
