...
CSP/nosniff; health; CORS; JWKS host; NFKC; SECURITY/README sync; ElementTree caps; S3/Local stream get caps; BFF design spike (`_2026_07.md`, `auth_bff` honesty, `GET /v1/auth/bff` → 501).
