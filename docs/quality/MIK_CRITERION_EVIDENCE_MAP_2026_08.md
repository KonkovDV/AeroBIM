...
closes_rt003: false
claim_boundary: >
  Findability pack for Appendix 2 and 3. Not a predicted total. Not
  certification. Not a filled K1 roster. Checkpoint NO_GO.
---
...
Историческое «07» в именах файлов **не** этот номер.
...
| К4 | Тираж; модель | [`K4_COMMERCIAL_PATH_2026_08.md`](K4_COMMERCIAL_PATH_2026_08.md); ADR-002; A1–A8 пустые часы | Выручка, второй контракт; 10,1 млрд как SAM; −72% как наш эффект |
...
| Код | Что комиссия должна увидеть | Где в git | Что git не закрывает |
|---|---|---|---|
| Б1 | Функционал + ограничения | TIER0; native RVT/NWD fail-closed; cap 256 МиБ | KPI партнёра письмом |
| Б2 | Протоколы **и** метрики валидации | Обложка фикстуры + WP-07 | Dual-rater на партнёре |
| Б3 | Импорт/экспорт MVP | Upload + BCF export; OIDC NOT_IMPLEMENTED | SSO; 1,5 ГБ analyze |
| Б4 | До/после | A1–A8 | Часы партнёра |
| Б5 | Поставка + прозрачность | [`KT3_DELIVERY_BOM_2026_08.md`](KT3_DELIVERY_BOM_2026_08.md) | Передача исключительных прав |
