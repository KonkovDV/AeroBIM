...
Публичный запрос (карточка [i.moscow/techlab/customer](https://i.moscow/techlab);
...
| Сверка между собой и с правилами | IDS + кросс-док + шаблонные нормы | Профиль заказчика канала не подписан |
