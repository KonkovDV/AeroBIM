...
| C-05 | Architecture inventory | 48 protocols / 76 adapters / 63 DI tokens | docs/evidence/runtime-baseline-latest.json architecture_inventory | VERIFIED_INTERNAL | нет | инвентарь архитектуры не критерий жюри |
