...
| C-01 | CI backend tests passed / collected / failed / skipped | 3420 / 3441 / 0 / 21 | docs/evidence/runtime-baseline-latest.json backend.*; attestation.attested_by=ci | VERIFIED_INTERNAL | да | CI: бэкенд 3420 из 3441, 0 упало, 21 skipped. |
| C-02 | CI frontend tests passed / failed | 404 / 0 | docs/evidence/runtime-baseline-latest.json frontend | VERIFIED_INTERNAL | да | CI: фронт 404 / 0. Только из runtime-baseline. |
