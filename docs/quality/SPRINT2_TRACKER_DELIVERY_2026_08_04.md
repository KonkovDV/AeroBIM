...
| 2 | Outreach: org list 30+ / contacted / demo | **числа только у владельца / `.local`** (не дублировать в GH) | локально: `.local/commercial-ops/commercial-pipeline.csv` · `.local/commercial-ops/outreach-log.md` |
