...
| **P1** | DrawingVQA (arXiv:2607.15418; CVPR Findings 2026): professionals **94.9 %** vs Gemini-3-pro-preview **77.2 %** (Gemini-2.5-pro **71.7 %**; undergraduates **62.8 %**). R3 / QTO families remain the bottleneck; original IFC drawing images are **not** fully public | VLM advisory; no sheet sign-off | TZ comparison tasks 1/3/7 closed; those % as AeroBIM |
...
| L-DVQA | arXiv:2607.15418; CVPR Findings 2026 | 33 IFC drawings, 92 QA; humans 94.9 % / Gemini-3-pro-preview 77.2 % / Gemini-2.5-pro 71.7 %; images not fully public | Sheet literacy gap; QTO/R3 weak | Those % as AeroBIM; Harbor-replacement |
