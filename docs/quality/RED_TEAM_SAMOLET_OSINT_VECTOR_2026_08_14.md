...
| RT-OSINT-02 | MED | **MITIGATED** | Temptation to invent Позднякова «сейчас в X» or «Самоходкин ушёл из группы» | OSINT people table: next employer **not asserted**; FAQ forbids naming post-exit titles |
