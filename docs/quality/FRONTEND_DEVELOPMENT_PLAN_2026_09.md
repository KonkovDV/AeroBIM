...
| До демо ИТ-ментору | WP-FE-07, WP-FE-08, WP-FE-09 | done |
| До 15.09 | WP-FE-10, WP-FE-11, WP-FE-12, WP-FE-13 | done |
| После фриза | WP-FE-14 | HOLD |
| Пока BFF = 501 | WP-FE-15 | HOLD |

Гейты после вечернего прохода: `npm test` — 35 файлов / 134 теста; `npm run lint` — чисто;
`npm run build` — чисто. `App.tsx` = 292 строки. Новая рантайм-зависимость не добавлялась.
