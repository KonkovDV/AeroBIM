...
| Friday commercial readiness | **OPEN** — contacts **0 / 0 / 0**; SSOT orgs **28** (< tracker ask 30+) |

## Findings

| ID | Sev | Status | Finding | Mitigation |
|---|---|---|---|---|
| RT-W2-01 | HIGH | **MITIGATED** | Org count contradicted (35 vs 39 vs SSOT) | Unified to **28** = `.local/commercial-ops/commercial-pipeline.csv`; legacy sprint2 CSV=40 marked superseded |
...
| RT-W2-03 | MED | **MITIGATED** | Baseline PDF cited old public CSV path | Generator + PDF regenerated: «28 SSOT (.local/…; не в GH)» |
...
| RT-W2-05 | MED | **MITIGATED** | Unsourced «NormaChecker 15 пилотов» in qa-defense | Softened to field-pilot reality without hard count |
| RT-W2-06 | MED | **MITIGATED** | «Четыре состояния» vs 5 operator labels | Doc retitled; five labels explicit; mirrors updated |
| RT-W2-07 | MED | **OPEN** | Outreach 0/0/0; owner caller / ≥10 emails / phone | Cannot close in code — owner action before Fri 08:00 |
...
2. Friday tracker ask «30+ orgs» — current SSOT **28**; do not invent 2 orgs.  
3. Contacted / replied / demo still **0 / 0 / 0**.  
