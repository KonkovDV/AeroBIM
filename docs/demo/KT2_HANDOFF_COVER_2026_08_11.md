...
4. Репетиция: [`KT2_DEMO_REHEARSAL_2026_08_12.md`](KT2_DEMO_REHEARSAL_2026_08_12.md). Питч: [`../partners/_TECHLAB_2026_08.md`](../partners/_TECHLAB_2026_08.md) — первые 15 с = формула, не раунд. Первые 30 с продукта: сценарий трекера №4, без публикации цифр без разметки.
...
4. Запрос заказчику: [`../partners/_08_15.md`](../partners/_08_15.md) (owner + ack 20.08).
