...
Если к КТ#3 нет пакета Самолёта (пункты 1–4 в [`../partners/SAMOLET_KT2_ASK_2026_08_15.md`](../partners/SAMOLET_KT2_ASK_2026_08_15.md)). **Не kill сегодня.** Вариант выбираем **15.09.2026**, не раньше.
...
Owner запроса: оператор (`KonkovDV`). Эскалация: Дмитрий Сигиневич. Ack Самолёта к **20.08**.
