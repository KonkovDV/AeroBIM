...
Checkpoint **`GO`**; `customer_go` false. Письмо заказчику канала отправляет человек, не репозиторий.

**После 25.08:** канал получен. Не говорить «нет данных заказчика». Хеш-пакет в git отсутствует. Перечень поставки: [`../quality/KT3_DELIVERY_BOM_2026_08.md`](../quality/KT3_DELIVERY_BOM_2026_08.md).
...
| TRK-04 | Наука / консультант | Вопросы в карточках КТ#3 | Выдуманные минуты консультаций |
...
Семь задач сравнения Техлаба — **не** эти шесть. Четыре бумаги заказчика канала не склеивать. M2/M8 Фонда — `VERIFY_WITH_OPERATOR`.
