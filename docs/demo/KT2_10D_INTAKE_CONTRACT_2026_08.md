...
Текущая схема OpenAPI (`GET /openapi.json`) описывает ручки AeroBIM (`/v1/uploads`, analyze, reports). Это **не** контракт 10D. Ниже — предлагаемые поля, когда граница согласована.
