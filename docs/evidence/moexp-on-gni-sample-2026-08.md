...
claim_boundary: >-
  Official MOEXP IDS executed on one GNI student IFC. Not CIM compliance, not appointing-party acceptance, not product accuracy. Does not overwrite the fixture MOEXP coverage snapshot.
---
