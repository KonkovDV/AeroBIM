...
**Зачем:** из 42% условных КР **25 п.п.** зависели от полноты комплекта, не от норм «заказчика канала». Проверить на открытых/синтетических данных, какие из 6 строк **реально срабатывают**.
