...
| [`rt-blocker-volumes-2026-09.md`](rt-blocker-volumes-2026-09.md) | Measurement substitutes vs residuals for RT-001/002/003. Schema 1.5.0 (`b1`/`b2`/`b3`). Undifferentiated closes stay false. Checkpoint GO; `customer_go` false |
| [`rt001-dual-rater-simulation-2026-09.md`](rt001-dual-rater-simulation-2026-09.md) · [`.json`](rt001-dual-rater-simulation-2026-09.json) | Two simulated independent passes on the fixture pack; live κ/α/AC1. Not humans. `closes_rt001=false` |
