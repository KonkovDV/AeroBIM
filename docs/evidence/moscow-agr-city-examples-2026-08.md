...
claim_boundary: >-
  City-published AGR CIM examples (stroimprosto.mos.ru cim-agr). Not a PD pack: no sheets, TZ, two revisions, calculations, or expertise remarks. Not a appointing-party-signed profile. Class-1 AGR exchange + official IDS engine coverage only. Checkpoint GO; customer_go false.
closes_rt001: false
closes_rt002b: false
closes_rt003: false
checkpoint: GO
