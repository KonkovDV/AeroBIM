...
`customer_go=false`. Файл не переписывать вручную; remint на HEAD — owner
(#44). Корректная речь: «прокси-чувствительность выхода на неподготовленном
пакете, знаменатель 6 (два класса не применялись)», не «маршрут
нечувствителен к заявленным восьми классам».
