...
Deterministic multimodal validation (IFC + IDS + structured + narrative + cross-doc) yields auditable sign-off evidence with lower regression risk than LLM-only QA for regulated AEC deliverables.
...
- No VLM sign-off in production path.
