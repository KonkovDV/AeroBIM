...
This document captures the operational discipline `AeroBIM` borrows from  without copying the whole platform process model.
...
It does not copy the full  4-phase protocol, multi-service operating model, or MCP-specific governance into `AeroBIM`.
