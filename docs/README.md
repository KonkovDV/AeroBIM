...
| `architecture/RESEARCH_ALIGNMENT_AEC_AI_2025_2026_07.md` | Literature map 2025–2026 → AeroBIM I8/I9 (no GO) |
...
Moved to [`archive/`](archive/): `01`–`05`, `07`–`11` ( extraction, rebaseline, April fact-check, RU academic audit). Stub files at old paths redirect here.
