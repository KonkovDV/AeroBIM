...
Public GitHub carries **only** materials needed for Samolet TechLab Task 07 jury review: product code, TZ pack, honest claims, architecture, citeable fixtures, and curated eng/Red Team summaries under `docs/quality/`. Operator runbooks, phase Red Team dumps, and MicroPhoenix archive live under `.local/` (not published).
