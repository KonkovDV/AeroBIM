...
Historical  extraction and rebaseline plans (`01`–`15`). Still accurate as reference; superseded for day-to-day pilot work by Tier 0 + Samolet docs. Prefer `PROJECT-AUDIT-2026-05-20.md` over `10-academic-audit` for current audit state.
...
| `08-microphoenix-adoption-matrix.md` | reference | exact extraction decisions from  |
