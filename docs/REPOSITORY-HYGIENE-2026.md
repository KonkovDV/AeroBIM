...
| **Explanation** | `archive/01-strategy-and-plan`, `archive/03-openbim-landscape` | Stakeholders (historical) |
| **Archive** | [`archive/`](archive/) — `01`–`11` snapshots; stubs at old paths | History only — not first read |
