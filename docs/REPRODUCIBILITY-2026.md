...
| **Rolling documentation** | branch `main` @ `334be6f` (2026-05-21) | Operator docs, weekly logs, [`evidence/pre-push-verification-2026-05-21.md`](evidence/pre-push-verification-2026-05-21.md) |
...
1. **Deterministic sign-off only** — no stochastic vision or fine-tuned extraction in pilot path.
