...
| Calculation match | load/qty/cross-doc/OpenRebar + xlsx/docx declared-field SHA | fixture | local LIRA binaries counted 30.08, not parsed | сверка only; ≠ solver; PDF fragile |
