...
| Hybrid AI routing foundation (classify/policy/guard/audit/gate) | `domain/hybrid/*` + 85 tests; domain-pure, verdict-neutral (OFF==ON), fail-closed, NOT in the verdict path — [`HYBRID_AI_FINAL_REPORT`](../audit/reports/HYBRID_AI_FINAL_REPORT_2026_07_28.md) |
