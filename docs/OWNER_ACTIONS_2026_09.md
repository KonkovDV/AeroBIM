...
| OA-24 | Прямого контакта с Самолётом нет. Единственный канал — организаторы. **14.09 — финальная дата** поставки заказчику | owner pin 09.09 | до **14.09** | Не ждать колл 15.09 как сдачу; повестка [`partners/SAMOLET_CALL_2026_09_15.md`](partners/SAMOLET_CALL_2026_09_15.md) не исходящее |
...
| OA-27 | Задача GitHub [#44](https://github.com/KonkovDV/AeroBIM/issues/44) (план исправлений после аудита, 09.09) — **бэклог пилота**, не закрывать без выполнения и не прятать. В материалах жюри объявить открытой | консистентность статусов | до речи / 14.09 | Комментарий или ярлык; закрытие только капитаном после факта |
