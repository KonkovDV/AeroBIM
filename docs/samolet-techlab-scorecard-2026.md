...
|----------|-------------|-------------------|
| TechLab jury (architecture fit) | **8,0–8,2** | **9,5+** |
| Samolet technical pilot | **7,0–7,5** | **10,0** (agreed scope) |
| Combined (honest) | **7,6** | **10,0** |

## R1–R15 ladder (today → target)

| ID | Requirement | Today | Target | Wave |
|----|-------------|------:|-------:|------|
| R1 | 2D drawings | 7 | 9,5 | 1–2 |
| R2 | BIM models | 9 | 10 | 0 |
| R3 | TZ + calculations | 8 | 9,5 | 1 |
| R4 | Norms / rules | 6 | 9 | 1 |
| R5 | Collisions | 7 | 9,5 | 1 |
| R6 | Areas / dimensions | 8 | 9,5 | 2 |
| R7 | Logic / missing | 8 | 9,5 | 1 |
| R8 | Problem zones | 8 | 9,5 | 1 |
| R9 | Prioritization | 8 | 10 | 0 |
| R10 | Designer comments | 7 | 9,5 | 1 |
| R11 | Faster review | 6 | 10 | 2 |
| R12 | Expert in loop | 10 | 10 | 0 |
| R13 | MVP + reports | 9 | 10 | 1 |
| R14 | Typical errors | 4 | 10 | 1–2 |
| R15 | SLA ≤ 30 min | 7 | 10 | 2 |
