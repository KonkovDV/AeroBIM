...
PAGES: list[list[str]] = [
    ...
    [
        ...
        "Киров КР n=24: ≈8,3% обнаруживается (Task 3: 2 строки open/synthetic);",
        "  условно ≈33% = ≈17п.п. norm + ≈17п.п. полнота/содержание не подтверждены",
        "Мордовия АР n=12: 17% (хрупко: ~8,3п.п./строка)",
        "Мордовия ВК n=16: 25%; условно 50%; вне обл. 13%; RT-003 = 13п.п.",
        "Тренд ≈8→17→25%. Не «закрыли 25п.п. полноты».",
        "Смета: RT-001 протокол · RT-002≈17 · RT-003=13.",
        "",
