...
FACT_ROWS: Final[tuple[dict[str, str | bool], ...]] = (
    ...
    _row(
        ...
        "docs/evidence/deep-study-carrier-facts-2026-08.md FireRating; IUA SAM-09; FINDING_VOLUME_CLAIM_BOUNDARY",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md §3 R1; TZ_COMPLIANCE_MATRIX §3.1; CHANNEL_LOCAL_MAX_PASS PDF HITL",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R2; deep-study-carrier-facts-2026-08.md",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R3; CALCULATION_COMPARE_FOUR_CHECKS; unpack-census parse_rvt_nwd_lira",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R4; demo_day_speech_lock PUBLIC_IDS_*; deep-study customer_approved_ids",
        "VERIFIED_INTERNAL",
        True,
        f"Публичные IDS: {PUBLIC_IDS_FILES} файлов, {PUBLIC_IDS_SPECS} spec. Подписи Самолёта нет.",
    ),
    _row(
        "B-R5",
        "R5 Collisions / clashes",
        "code+planted/open rehearsal; customer MEP IFC entities=0; 837≠channel",
        "docs/samolet-techlab-alignment-2026.md R5; federated-clash-duplex-2026-08.json; deep-study mep_duct_pipe_cable_count",
        "SYNTHETIC",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R6; system_capabilities space_area_from_geometry",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R7; FINDING_VOLUME_CLAIM_BOUNDARY target_ref=ALL",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R8; docs/evidence/drawing-overlay-smoke-2026-08/README.md",
        "SYNTHETIC",
        True,
    ...
    _row(
        ...
        "closed_by_code AEROBIM_PRIORITY_PROFILE=samolet; not measured on customer queue",
        "docs/samolet-techlab-alignment-2026.md R9; domain/review_priority.py",
        "VERIFIED_INTERNAL",
        False,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R10; TemplateRemarkGenerator; ADR-001",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R11; audit/evidence/samolet-sla-fixture-honesty-2026-07-17.json",
        "SYNTHETIC",
        False,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R13; UI_EXPERT_WORKPLACE_TRIAGE_2026_09.md",
        "VERIFIED_INTERNAL",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R14; samples/benchmarks/samolet-typical-errors-catalog.json; accuracy-answer typical_error_class_coverage",
        "SYNTHETIC",
        True,
    ...
    _row(
        ...
        "docs/samolet-techlab-alignment-2026.md R15; samolet-sla-fixture-honesty-2026-07-17.json; TZ_COMPLIANCE_MATRIX §6",
        "SYNTHETIC",
        True,
    ...
    _row(
        "B-IDS-MOEXP",
        "IDS Мособлгосэкспертизы (не профиль Самолёта)",
    ...
    _row(
        ...
        "NO_DATA (required cores); RAM planning multiplier 10 is literature not Samolet RSS",
        "docs/quality/IFC_ANALYZE_VS_INGEST_CAP_2026_08.md; KT3_JURY_FAQ RSS на файле Самолёта не замерен",
        "NO_DATA",
        False,
    ...
    _row(
        "D-08",
        "Лимиты объёмов",
        "SPF 256 MiB; model ingest/analyze 1.5 GB RocksDB on samolet_pilot/production; Office 500 MB",
    ...
    _row(
        ...
        E1_TEXT,
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md table E1",
        "NEEDS_CUSTOMER",
        True,
    ...
    _row(
        ...
        E2_TEXT,
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md table E2",
        "NEEDS_CUSTOMER",
        True,
    ...
    _row(
        ...
        E3_TEXT,
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md table E3",
        "NEEDS_CUSTOMER",
        False,
    ...
    _row(
        ...
        E4_TEXT,
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md table E4",
        "NEEDS_CUSTOMER",
        True,
    ...
    _row(
        ...
        E5_TEXT,
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md table E5",
        "NEEDS_CUSTOMER",
        True,
    ...
    _row(
        "E-07",
        "Число 1 от Самолёта: календарные дни круга согласования РД",
        "NO_DATA; who: technological-customer director / PMO of the section",
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md E2; DEMO_DAY_SPEECH_LOCK three numbers",
        "NEEDS_CUSTOMER",
        False,
        "запросить письмом",
    ),
    _row(
        "E-08",
        "Число 2 от Самолёта: часы эксперта «до» на эталонном комплекте",
    ...
    _row(
        "E-09",
        "Число 3 от Самолёта: сколько лишних кругов они считают нормой на типовой секции",
        "NO_DATA; who: information-modelling lead (typification) + tech-customer",
        "docs/partners/SAMOLET_CYCLE_ECONOMICS_ASSUMPTIONS_2026_09.md E1 E5",
        "NEEDS_CUSTOMER",
        False,
        "запросить письмом",
    ),
    _row(
        ...
        "docs/evidence/deep-study-carrier-facts-2026-08.md t_manual_s is null; samolet-sla-fixture-honesty-2026-07-17.json claim_level=fixture_only",
        "NO_DATA",
        True,
...
CONTRADICTIONS: Final[tuple[dict[str, str], ...]] = (
    ...
    {
        "id": "X-03",
        "where": "samolet-techlab-alignment R1–R15 checkmarks vs this pack",
