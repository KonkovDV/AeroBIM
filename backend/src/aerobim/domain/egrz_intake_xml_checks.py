...
SCHEMA_CATALOG: Final[tuple[dict[str, Any], ...]] = (
    ...
    },
    {
        ...
        "zip_member": ("explanatorynote-dev_explanatorynote_v_1_07/explanatorynote-01-07.xsd"),
    ...
    },
    {
        ...
        "zip_member": ("DesignAssignment-dev_DesignAssignment_v_1_01/DesignAssignment-01-01.xsd"),
        "zip_member_folder_note": (
