...
LEDGER: tuple[InferenceRow, ...] = (
    ...
    _row(
        ...
        "docs/partners/WEDGE_FREEZE_EVIDENCE_LAYER_2026_08_16.md",
    ...
    _row(
        "TRK-04",
        "tracker",
        "Задача 4: Бурнаев / ИТ-ментор Михаил",
        "Вопросы и демо-ссылка в репозитории",
        "Выдуманные минуты консультаций",
        "docs/demo/TRACKER_MEETING_2026_08_14.md",
...
def render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        ...
        "имеют право значить для Самолёта, трекера Дмитрия, Техлаба, МИК и "
