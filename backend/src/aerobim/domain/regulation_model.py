...
class RuleInterpretation:
    ...
    @property
    def reviews_approved(self) -> bool:
        return all(
...
class ComplianceRule:
    ...
    applicability_filter: str | None = None
    ...
    def reviews_approved(self) -> bool:
        return (
            self.approval_status == ReviewStatus.APPROVED and self.interpretation.reviews_approved
        )
...
class NormPack:
    ...
    def production_rules(self) -> list[ComplianceRule]:
        ...
        return [r for r in self.rules if r.reviews_approved()]
