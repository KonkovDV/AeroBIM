class Tokens:
    ...
    ADVISORY_VLM_PIPELINE = "advisory_vlm_pipeline"
    ...
    IFC_KNOWLEDGE_GRAPH = "ifc_knowledge_graph"
    SYSTEM_CLASH = "system_clash"
    REQUIREMENT_INTERPRETER = "requirement_interpreter"
    CAD_ENTITY_LOADER = "cad_entity_loader"
    ...
    LLM_EXTRACTION_REGEX = "llm_extraction_regex"
    LLM_EXTRACTION_KIMI = "llm_extraction_kimi"
    LLM_EXTRACTION_QWEN = "llm_extraction_qwen"
