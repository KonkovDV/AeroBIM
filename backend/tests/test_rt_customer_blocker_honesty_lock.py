...
class JuryPackHygieneTests(unittest.TestCase):
    ...
    def test_operator_kitchen_is_unpublished_from_git(self) -> None:
        forbidden = (
            ...
            "docs/OWNER_ACTIONS_2026_09.md",
            "docs/quality/KT3_IN_REPO_WORKPLAN_2026_08_27.md",
            "docs/quality/KT3_INTERROGATION_PACK_2026_09.md",
            "docs/quality/KT3_HYPERPLAN_TRIAGE_RT_WH_2026_09.md",
            "docs/quality/KT3_WINDOW_CRITICAL_PATH_2026_09.md",
            "docs/quality/KT3_PLAN_B_2026_08.md",
            "docs/quality/FRONTEND_DEVELOPMENT_PLAN_2026_09.md",
            "docs/ai/ACADEMIC_LIT_RADAR.md",
            "docs/ai/ACADEMIC_COAUTHOR.md",
            "docs/partners/KT3_CUSTOMER_DELIVERY_14_09.md",
            "docs/partners/KT3_ORGANIZER_REPLY_14_09.md",
            "docs/partners/MIK_OPERATOR_LETTER_REQUEST_2026_09.md",
            "docs/partners/I_MOSCOW_APPLICATION_PASTE_2026_08.md",
...
class SubmissionPackHonestyTests(unittest.TestCase):
    ...
    def test_presentation_pack_tracks_main_deck(self) -> None:
        ...
        slides = root / "demo_day_slides.md"
        ...
        self.assertIn("AeroBIM.pptx", tracked)
        self.assertIn("AeroBIM.pdf", tracked)
        self.assertNotIn("AeroBIM_demo_day_09.pptx", tracked)
