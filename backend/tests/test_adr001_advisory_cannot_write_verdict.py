...
class Adr001AdvisoryCannotWriteVerdictTests(unittest.TestCase):
    ...
    def test_advisory_draft_drops_verdict_keys_and_has_no_passed_field(self) -> None:
        ...
        self.assertEqual(remark.essence, "Черновик")
        self.assertFalse(remark.clause_bound)
        self.assertEqual(remark.clause_cite, "пункт нормы не привязан")
        self.assertIsNone(remark.storey_name)
        self.assertIsNone(remark.grid_axis)
