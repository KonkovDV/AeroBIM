...
Файл деки готовит оператор к 19.08 и прикладывает в форму ссылкой. В git лежит **каркас, текст слайдов и дисциплина формулировок**, а не бинарник, — чтобы слайды нельзя было разойтись с реестром заявлений.
