...
| Презентация | [`03-presentation/`](03-presentation/README.md) | [`demo_day_slides.md`](03-presentation/demo_day_slides.md); бинарный `AeroBIM_demo_day.pdf` не в git (kitchen B-01) |
