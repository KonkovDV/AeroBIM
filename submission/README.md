...
**Команда:** AeroBIM · **Задача:** автоматизированная верификация проектной и рабочей документации · **Демо-день:** 21.09.2026
...
| Презентация | [`03-presentation/`](03-presentation/README.md) | [`demo_day_slides.md`](03-presentation/demo_day_slides.md); [`AeroBIM.pptx`](03-presentation/AeroBIM.pptx); [`AeroBIM.pdf`](03-presentation/AeroBIM.pdf) |
...
| Кадр | Файл | Живой след |
|---|---|---|
| 1–7 | [`AeroBIM.pptx`](03-presentation/AeroBIM.pptx) · [`AeroBIM.pdf`](03-presentation/AeroBIM.pdf) · [текст](03-presentation/demo_day_slides.md) | Дека демо-дня |
| 4 | [прототип](04-prototype/README.md) | CLI находит посаженные дефекты git. Узел 30/40 мм — схема слайда |
| 3 | [дополнительно](05-additional/README.md) | 0,86 / 10/10 / 1/8 — учебные наборы, не комплект заказчика |
| 5–6 | [документация](02-documentation/README.md) | ADR-001, граница заявлений, пилот |
