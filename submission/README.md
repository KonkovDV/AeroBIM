...
**Команда:** AeroBIM · **Задача:** 07 «Система автоматизированной верификации проектной и рабочей документации» · **Заказчик:** заказчика · **Окно КТ#3:** 03–21.09.2026 · **Финал:** 29–30.09.2026 · **Архив КТ#2:** 20.08.2026
...
Точность продукта на комплекте заказчика; выполненный SLA заказчика; чтение DWG / RVT / NWD без конвертации; сданный MEP system clash; доказанный импорт BCF в СОД; независимую корректность расчётов; production-статус.
