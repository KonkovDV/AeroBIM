...
| Стол | Что открыть |
|---|---|
| Жюри Техлаба | Формула выше → [`04-prototype/`](04-prototype/README.md) |
| МИК | Стадия = доработка; валидация эффективности и внедрение не начаты |
| Трекер | [`../docs/demo/TRACKER_MEETING_2026_08_14.md`](../docs/demo/TRACKER_MEETING_2026_08_14.md) (14.08 + addendum 17.08) |
| ИТ-ментор | [`01-repository/`](01-repository/README.md) · CI pin `acac02bd` / 2455 |
| Научный консультант | [Kane IUA ledger](../docs/quality/INTERPRETATION_USE_LEDGER_2026_08.md) (freeze `f9389bf`) |
| Венчур | Юрлица нет; ask = слот + размеченный комплект, не SAFE |
