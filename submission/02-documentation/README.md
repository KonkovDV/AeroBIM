...
[`../../docs/partners/SAMOLET_KT2_ASK_2026_08_15.md`](../../docs/partners/SAMOLET_KT2_ASK_2026_08_15.md) — четыре пункта intake: комплект одной ревизии, подписанный профиль приёмки, два инженера-разметчика, целевая СОД для BCF. Без них измерение на данных заказчика невозможно, и Checkpoint остаётся `NO_GO`.
