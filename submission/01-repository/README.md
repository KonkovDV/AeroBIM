...
Эти проверки запрещают в публичных текстах заявления, не подкреплённые доказательствами, — включая наши собственные. После правок документации CI pin может отставать от HEAD до следующего прогона CI.
