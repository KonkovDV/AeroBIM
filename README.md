...
tests_passed: backend=2163, frontend=48; commit 3489cad44697; see docs/evidence/runtime-baseline-latest.json · src ~61743 LOC; tests ~42440 LOC; extraction macro_f1=0.86 (fixture corpus; not product accuracy)
