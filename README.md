...
TechLab / MIK jury: formula above → [`submission/README.md`](submission/README.md) → the command just above. This is a refinement pack, not a Checkpoint act.
...
tests_passed: backend=2644, frontend=57; commit aea618ddfdc0; see docs/evidence/runtime-baseline-latest.json · src ~83954 LOC; tests ~54620 LOC; extraction macro_f1=0.8600000000000001 (fixture corpus; not product accuracy)
